...
class IndexView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        try:
            from apps.usuarios.models import Usuario, SolicitudProfesor
            ...
            context['total_solicitudes_pendientes'] = SolicitudProfesor.objects.filter(estado='pendiente').count()
            context['total_cursos_pendientes'] = Curso.objects.filter(estado='pendiente').count()
        except Exception:
            context['total_cursos'] = 0
            context['total_estudiantes'] = 0
            context['total_profesores'] = 0
            context['total_inscripciones'] = 0
            context['total_solicitudes_pendientes'] = 0
            context['total_cursos_pendientes'] = 0
        return context
